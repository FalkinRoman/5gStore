...
<div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__shake" src="/adminlte/dist/img/5G store logo.png" alt="AdminLTELogo" height="20" width="100">
    </div>
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a  target="_blank" href="{{ route('index') }}" class="nav-link">Сайт</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
    ...
    <!-- Вверхняя часть слева контейнер -->
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- Brand Logo -->
        <a href="{{ route('admin.main') }}" class="brand-link">
            <img src="/adminlte/dist/img/5glogo.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="/adminlte/dist/img/kristmas.jpg" class="img-circle elevation-2" alt="User Image">
                </div>
                <div class="info">
                    <a href="{{ route('admin.main') }}" class="d-block">Фалькин Роман</a>
                </div>
            </div>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.cryptocurrencies.index') }}" class="nav-link">
...
{{--        уведомление об ошибке или удалении--}}
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2022-{{ now()->year }} <a href="">5G STORE</a>.</strong>
        Все права защищены.
