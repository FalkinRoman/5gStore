            ...
            <div class="cards-slider">
                <div class="card">
                    <div class="card-top-container flex center">
                        <div class="card-box-dinamic">
                            <div class="card-hiden-img flex center">
                                <img src="img/1_311583-transformed.png" alt="">
                                <img src="img/3_311583-transformed.png" alt="">
                            </div>
                        </div>
                        <div class="bar">
                    ...
                    <div class="card-down-container flex column">
                        <p style="font-size: 14px;">Наушники Apple AirPods 3</p>
                        ...
                        <div class="card-cashback flex center">
                            <div class="container-cashback flex center">
                                <div class="container-cashback-percent">
                                    <p style="font-size: 12px; color: #ffffff; font-weight: 500;">10%</p>
                                </div>
                                <p style="margin-left: 3px;">+0.003</p>
                                <img style="margin:0 3px;" src="img/bitcoin1.svg" alt="">
                            </div>
                        </div>
                        ...
                        <div class="price-button flex center">
                            <div  class="card-price flex center">
                                ...
                                <p style="font-size: 19px; font-weight: 600; margin-right: 8px;">17 990 ₽</p>
                            </div>
